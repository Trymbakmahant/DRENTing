        ...
        <div className="flex justify-between ... pt-20 pb-40">
          ...
          <p className="text-2xl bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-lime-50 pt-20 pr-10 pl-10">
            ...
            <div className="pb-10 text-justify">
              ...
              intermediaries. This means that personal data and money will be
              kept securely on the blockchain, without the risk of being hacked
              or misused by third parties. It also means that merchants can
              offer their goods and services directly to consumers, without the
              fees and restrictions imposed by traditional e-commerce platforms.
