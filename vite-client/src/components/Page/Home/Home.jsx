    ...
    <div className="grid justify-items-center   pt-20">
      ...
      {posts && (
        <p className="text-4xl bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-lime-50 pt-20	">
          Total items listed in our website :- {posts.length}
        </p>
      )}
      <div className="flex justify-between ... pt-20 pb-40">
        ...
        <p className="text-2xl bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-lime-50 pt-20 pr-10 pl-10">
          ...
          <div className="pb-10 text-justify">
            ...
            Decentralized e-commerce is not only about security and control, its
            about creating a more equitable and accessible online marketplace.
            It enables anyone, anywhere in the world, to participate in the
            global economy, regardless of their financial status or geographic
            location.
          </div>
          <br />
          <div className="ml-40">
